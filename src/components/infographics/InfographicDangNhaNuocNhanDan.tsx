  ...
  return (
    <EditorialReveal className="my-0.5 p-3 sm:p-4 rounded-lg bg-paper-light/95 border border-accent/30 shadow-2xs text-ink">
      ...
      <div className="grid grid-cols-3 gap-2 mb-2.5">
        <div className="p-2 sm:p-2.5 rounded bg-paper border border-accent/25 text-center">
          <span className="font-mono text-[11px] text-accent-dark uppercase font-bold tracking-wider block mb-0.5">
            LÃNH ĐẠO
          </span>
          <h5 className="font-serif font-bold text-primary text-[13.5px] sm:text-sm">
            ĐẢNG LÃNH ĐẠO
          </h5>
          <p className="font-sans text-xs sm:text-[12.5px] text-ink/85 mt-0.5 leading-normal">
        ...
        <div className="p-2 sm:p-2.5 rounded bg-paper border border-accent/25 text-center">
          ...
          <h5 className="font-serif font-bold text-accent-dark text-[13.5px] sm:text-sm">
            NHÀ NƯỚC QUẢN LÝ
          </h5>
          <p className="font-sans text-xs sm:text-[12.5px] text-ink/85 mt-0.5 leading-normal">
        ...
        <div className="p-2 sm:p-2.5 rounded bg-paper border border-accent/25 text-center">
          ...
          <h5 className="font-serif font-bold text-primary-dark text-[13.5px] sm:text-sm">
            NHÂN DÂN LÀM CHỦ
          </h5>
          <p className="font-sans text-xs sm:text-[12.5px] text-ink/85 mt-0.5 leading-normal">
      ...
      <div className="border-t border-accent/25 pt-2.5">
        <span className="text-xs font-mono uppercase tracking-wider text-accent-dark font-bold block mb-2 text-center">
          ...
          {branches.map((b, idx) => {
            ...
            return (
              <button
                ...
                className={`p-2 rounded border text-left transition-all min-h-[44px] flex flex-col justify-between ${
                  isSelected
              ...
              >
                <div>
                  ...
                  <span className="font-serif text-[13px] sm:text-sm font-bold uppercase tracking-wider">
                    {b.title}
                  </span>
                </div>
                <span
                  className={`font-sans text-xs font-medium italic mt-0.5 ${
                    isSelected ? "text-paper-light/90" : "text-ink/80"
                  }`}
                >
                  {b.org}
                </span>
        ...
        <div key={selectedBranch} className="p-3 sm:p-3.5 rounded bg-paper border border-accent/25 editorial-tab-panel">
          <h6 className="font-serif text-sm sm:text-base font-bold text-primary mb-1">
            Nhánh {branches[selectedBranch].title} ({branches[selectedBranch].org})
          </h6>
          <p className="font-sans text-xs sm:text-[13.5px] text-ink leading-relaxed mb-2">
            {branches[selectedBranch].desc}
          </p>
          <div className="space-y-1 pt-1.5 border-t border-accent/15">
            <span className="text-xs font-mono uppercase text-accent-dark font-bold block">
              Nhiệm vụ trọng tâm:
            </span>
